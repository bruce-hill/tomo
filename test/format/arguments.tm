...
struct Packed{f1x:Bool, f2:Bool, f3:Bool, f4:Bool, f5:Bool, f6:Bool, f7:Bool, f8:Bool, f9:Bool; packed_bools}

enum Wide(Variant1{x:Int, y:Int}, Variant2{x:Int, y:Int}, Variant3{x:Int, y:Int}, Variant4{x:Int, y:Int}, Variant5{x:Int, y:Int}, Variant6{x:Int, y:Int})

# A variant is a field list too, so one that doesn't fit breaks inside the
# enum that holds it:
enum Nested(Small, Roomy{f1xxxxxxxxxxxxxxxxxxxxxxxxx:Float64, f2:Float64, f3:Float64, f4:Float64, f5:Float64, f6:Float64; packed_bools})
